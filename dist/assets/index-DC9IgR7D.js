...
`;var k=function(t,e,s,a){var r=arguments.length,o=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,s):a,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,s,a);else for(var d=t.length-1;d>=0;d--)(u=t[d])&&(o=(r<3?u(o):r>3?u(e,s,o):u(e,s))||o);return r>3&&o&&Object.defineProperty(e,s,o),o};const ye=4e3;let P=class extends H{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=l.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return p`
    ...
    `}getPaymentIcon(){var s;const e=l.state.currentPayment;if(e){if(e.type==="exchange"){const a=e.exchangeId;if(a){const r=l.getExchangeById(a);return r==null?void 0:r.imageUrl}}if(e.type==="wallet"){const a=(s=A.state.connectedWalletInfo)==null?void 0:s.icon;if(a)return a;const r=h.state.activeChain;if(!r)return;const o=Y.getConnectorId(r);if(!o)return;const u=Y.getConnectorById(o);return u?Q.getConnectorImage(u):void 0}}}successTemplate(){return p`<wui-icon size="xl" color="success" name="checkmark"></wui-icon>`}errorTemplate(){return p`<wui-icon size="xl" color="error" name="close"></wui-icon>`}};P.styles=me;k([y()],P.prototype,"loadingMessage",void 0);k([y()],P.prototype,"subMessage",void 0);k([y()],P.prototype,"paymentState",void 0);P=k([K("w3m-pay-loading-view")],P);const he=3e5;async function we(t){return l.handleOpenPay(t)}async function Ie(t,e=he){if(e<=0)throw new c(i.INVALID_PAYMENT_CONFIG,"Timeout must be greater than 0");try{await we(t)}catch(s){throw s instanceof c?s:new c(i.UNABLE_TO_INITIATE_PAYMENT,s.message)}return new Promise((s,a)=>{let r=!1;const o=setTimeout(()=>{r||(r=!0,b(),a(new c(i.GENERIC_PAYMENT_ERROR,"Payment timeout")))},e);function u(){if(r)return;const f=l.state.currentPayment,v=l.state.error,j=l.state.isPaymentInProgress;if((f==null?void 0:f.status)==="SUCCESS"){r=!0,b(),clearTimeout(o),s({success:!0,result:f.result});return}if((f==null?void 0:f.status)==="FAILED"){r=!0,b(),clearTimeout(o),s({success:!1,error:v||"Payment failed"});return}v&&!j&&!f&&(r=!0,b(),clearTimeout(o),s({success:!1,error:v}))}const d=O("currentPayment",u),N=O("error",u),_=O("isPaymentInProgress",u),b=fe([d,N,_]);u()})}function Pe(){return l.getExchanges()}function _e(){var t;return(t=l.state.currentPayment)==null?void 0:t.result}function Te(){return l.state.error}function Se(){return l.state.isPaymentInProgress}function O(t,e){return l.subscribeKey(t,e)}function fe(t){return()=>{t.forEach(e=>{try{e()}catch{}})}}const Ce={network:"eip155:8453",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},be={network:"eip155:8453",asset:"0x833589fcd6edb6e08f4c7c32d4f71b54bda02913",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},xe={network:"eip155:84532",asset:"native",metadata:{name:"Ethereum",symbol:"ETH",decimals:18}},Ue={network:"eip155:1",asset:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},ke={network:"eip155:10",asset:"0x0b2c639c533813f4aa9d7837caf62653d097ff85",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},ve={network:"eip155:42161",asset:"0xaf88d065e77c8cC2239327C5EDb3A432268e5831",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Re={network:"eip155:137",asset:"0x3c499c542cef5e3811e1192ce70d8cc03d5c3359",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},De={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",metadata:{name:"USD Coin",symbol:"USDC",decimals:6}},Oe={network:"eip155:1",asset:"0xdAC17F958D2ee523a2206206994597C13D831ec7",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Le={network:"eip155:10",asset:"0x94b008aA00579c1307B0EF2c499aD98a8ce58e58",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Me={network:"eip155:42161",asset:"0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ge={network:"eip155:137",asset:"0xc2132d05d31c914a87c6611c10748aeb04b58e8f",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ye={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB",metadata:{name:"Tether USD",symbol:"USDT",decimals:6}},Ve={network:"solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp",asset:"native",metadata:{name:"Solana",symbol:"SOL",decimals:9}};export{P as W3mPayLoadingView,m as W3mPayView,ve as arbitrumUSDC,Me as arbitrumUSDT,Ce as baseETH,xe as baseSepoliaETH,be as baseUSDC,Ue as ethereumUSDC,Oe as ethereumUSDT,Pe as getExchanges,Se as getIsPaymentInProgress,Te as getPayError,_e as getPayResult,we as openPay,ke as optimismUSDC,Le as optimismUSDT,Ie as pay,Re as polygonUSDC,Ge as polygonUSDT,Ve as solanaSOL,De as solanaUSDC,Ye as solanaUSDT};
